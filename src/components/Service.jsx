...
const Service = () => {
  return (
    <section className="container h-12 md:h-32">
      <div className="mx-auto my-4 grid w-full -translate-y-10 grid-cols-4 divide-x divide-green-400 bg-green-200 p-2 shadow-lg dark:bg-green-500 dark:text-white/70 md:max-w-[800px] md:-translate-y-16 md:p-8">
